...
//Single connection for all db Queries 
    ...
    private DbConnectionManager(String url) throws ClassNotFoundException {
        try {
    ...
    public static DbConnectionManager getDbInstance(String url) throws SQLException, ClassNotFoundException {
        if (dbInstance == null) {
